...
\begin{equation*}
\left(\bm{X}^T \bm{X} \right)^{-1} \bm{X}^T \bm{y} = \dfrac{1}{n\sum_{i=1}^{n}x_i - \left(\sum_{i=1}^{n}x_i\right)}\begin{pmatrix}
\sum_{i=1}^n x_i^2 & -\sum_{i=1}^n x_i\\
-\sum_{i=1}^n x_i & n\\
\end{pmatrix}
\begin{pmatrix}
...
\vdots \\
y_n
\end{pmatrix} = \dfrac{1}{n\sum_{i=1}^{n}x_i - \left(\sum_{i=1}^{n}x_i\right)}
\begin{pmatrix}
