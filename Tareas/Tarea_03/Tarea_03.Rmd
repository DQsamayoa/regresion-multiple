...
\begin{align*}
SCE= \sum_i^n(y_i-\hat\beta_0-\hat\beta_1x_i) ^2
\end{align*}

\begin{align*}
S_{yy}= \sum_i^n(y_i-\bar{y_n})^2
\end{align*}

#Ejercicio 2
Mostrar la desigualdad de Bonferroni. Si $E_1,\cdots ,E_k$ son eventos en un espacio de probabilidad
$(\omega, A, P)$ entonces 


\begin{align*}
Pr(\cap{E_j}) \geq 1-Pr(E_j^c) 
\end{align*}
